  ...
  units: [
    ...
    // ---- 高三總複習 ----
    {
      ...
      quiz: [
        {
          id: 'math-u17-q1',
          question: '學測數學混合題型中,非選擇題的評分方式通常為?',
          options: ['只看最終答案對錯', '依解題步驟給部分分數', '完全不計分', '只看字跡工整程度'],
          answer: 1,
          explanation: '非選擇題採計分步驟給分,即使最終答案錯誤,正確的解題過程仍能拿到部分分數。',
        },
        {
          id: 'math-u17-q2',
          question: '應用題(文字題)的解題第一步驟通常是?',
          options: ['直接計算數字', '把文字敘述轉換成數學式(列式)', '先看選項用代入法', '跳過不寫'],
          answer: 1,
          explanation: '應用題應先將文字敘述轉換成正確的數學式(列式),這是拿分的關鍵步驟。',
        },
        {
          id: 'math-u17-q3',
          question: '檢查計算結果是否合理(例如機率不能為負),主要目的是?',
          options: ['浪費時間沒有幫助', '快速抓出計算過程中的錯誤', '增加答題字數', '沒有實際用途'],
          answer: 1,
          explanation: '檢查答案是否符合合理範圍,能快速抓出計算過程中的錯誤,提升答題正確率。',
        },
      ],
    },
    {
      ...
      quiz: [
        {
          id: 'math-u18-q1',
          question: '複習學測數學歷屆試題,較有效的整理方式是?',
          options: ['只依年份順序刷題', '依主題(函數、數列、機率等)分類整理', '只做選擇題不練習列式', '完全不用複習基礎的高一觀念'],
          answer: 1,
          explanation: '依主題分類整理歷屆試題,更容易看出各主題的常考類型與命題趨勢。',
        },
        {
          id: 'math-u18-q2',
          question: '面對「因粗心計算錯誤」與「因觀念不熟」兩類錯題,較好的因應方式是?',
          options: [
            '用同樣方式處理即可',
            '分別用不同方式加強(如加強驗算習慣 vs 重新理解觀念)',
            '兩者都不需要特別處理',
            '只加強觀念不熟的部分即可',
          ],
          answer: 1,
          explanation: '粗心計算錯誤應加強驗算習慣,觀念不熟則需重新理解該觀念,兩者成因不同,加強方式也應不同。',
        },
        {
          id: 'math-u18-q3',
          question: '考前衝刺階段,較建議的複習方式是?',
          options: ['只看課本不做題目', '限時模擬完整份考古題,訓練時間分配', '把所有公式抄寫十遍', '完全不複習高一高二的內容'],
          answer: 1,
          explanation: '考前衝刺階段以限時模擬完整份考古題為主,能訓練實際考試的時間分配與應試節奏。',
        },
      ],
    },
  ],
